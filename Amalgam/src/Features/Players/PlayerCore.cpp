...
void CPlayerlistCore::SavePlayerlist()
{
	...
	try
	{
		...
		SDK::Output("pastegram", "Saved playerlist", INFO_COLOR, OUTPUT_CONSOLE | OUTPUT_TOAST | OUTPUT_MENU | OUTPUT_DEBUG, ICON_MD_INFO);
	}
	catch (...)
	{
		SDK::Output("pastegram", "Save playerlist failed", ERROR_COLOR, OUTPUT_CONSOLE | OUTPUT_TOAST | OUTPUT_MENU | OUTPUT_DEBUG, ICON_MD_CANCEL);
	}
}
...
void CPlayerlistCore::LoadPlayerlist()
{
	...
	try
	{
		...
		if (auto tSub = tRead.get_child_optional("Config"))
		{
			...
			SDK::Output("pastegram", "Playerlist config not found", ERROR_COLOR, OUTPUT_CONSOLE | OUTPUT_TOAST | OUTPUT_MENU | OUTPUT_DEBUG, ICON_MD_CANCEL);
		...
		if (auto tSub = tRead.get_child_optional("Tags"))
		{
			...
			SDK::Output("pastegram", "Playerlist tags not found", ERROR_COLOR, OUTPUT_CONSOLE | OUTPUT_TOAST | OUTPUT_MENU | OUTPUT_DEBUG, ICON_MD_CANCEL);
		...
		if (auto tSub = tRead.get_child_optional("Aliases"))
		{
			...
			SDK::Output("pastegram", "Playerlist aliases not found", ERROR_COLOR, OUTPUT_CONSOLE | OUTPUT_TOAST | OUTPUT_MENU | OUTPUT_DEBUG, ICON_MD_CANCEL);

		SDK::Output("pastegram", "Loaded playerlist", INFO_COLOR, OUTPUT_CONSOLE | OUTPUT_TOAST | OUTPUT_MENU | OUTPUT_DEBUG, ICON_MD_INFO);
	}
	catch (...)
	{
		SDK::Output("pastegram", "Load playerlist failed", ERROR_COLOR, OUTPUT_CONSOLE | OUTPUT_TOAST | OUTPUT_MENU | OUTPUT_DEBUG, ICON_MD_CANCEL);
	}
