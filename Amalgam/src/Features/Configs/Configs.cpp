...
CConfigs::CConfigs()
{
	m_sConfigPath = std::filesystem::current_path().string() + "\\pastegram\\";
...
static inline void LoadMain(BaseVar*& pBase, boost::property_tree::ptree& tTree)
{
	...
	if (auto tMap = tTree.get_child_optional(pVar->Name()))
	{
		...
		SDK::Output("pastegram", std::format("{} not found", pVar->Name()).c_str(), ERROR_COLOR, OUTPUT_CONSOLE | OUTPUT_TOAST | OUTPUT_MENU | OUTPUT_DEBUG, ICON_MD_CANCEL);
}
...
bool CConfigs::SaveConfig(const std::string& sConfigName, bool bNotify)
{
	try
	{
		...
		if (bNotify)
			SDK::Output("pastegram", std::format("Config {} saved", sConfigName).c_str(), INFO_COLOR, OUTPUT_CONSOLE | OUTPUT_TOAST | OUTPUT_MENU | OUTPUT_DEBUG, ICON_MD_INFO);
	}
	catch (...)
	{
		SDK::Output("pastegram", "Save config failed", ERROR_COLOR, OUTPUT_CONSOLE | OUTPUT_TOAST | OUTPUT_MENU | OUTPUT_DEBUG, ICON_MD_CANCEL);
		return false;
	}
...
bool CConfigs::LoadConfig(const std::string& sConfigName, bool bNotify)
{
	try
	{
		...
		if (auto tSub = tRead.get_child_optional("Binds"))
		{
			...
			SDK::Output("pastegram", "Config binds not found", ERROR_COLOR, OUTPUT_CONSOLE | OUTPUT_TOAST | OUTPUT_MENU | OUTPUT_DEBUG, ICON_MD_CANCEL);
			...
			tSub || (tSub = tRead.get_child_optional("ConVars")))
		{
			...
			SDK::Output("pastegram", "Config vars not found", ERROR_COLOR, OUTPUT_CONSOLE | OUTPUT_TOAST | OUTPUT_MENU | OUTPUT_DEBUG, ICON_MD_CANCEL);
		...
		if (auto tSub = tRead.get_child_optional("Groups"))
		{
			...
			SDK::Output("pastegram", "Config groups not found", ERROR_COLOR, OUTPUT_CONSOLE | OUTPUT_TOAST | OUTPUT_MENU | OUTPUT_DEBUG, ICON_MD_CANCEL);
		...
		m_sCurrentConfig = sConfigName; m_sCurrentVisuals = "";
		if (bNotify)
			SDK::Output("pastegram", std::format("Config {} loaded", sConfigName).c_str(), INFO_COLOR, OUTPUT_CONSOLE | OUTPUT_TOAST | OUTPUT_MENU | OUTPUT_DEBUG, ICON_MD_INFO);
	}
	catch (...)
	{
		SDK::Output("pastegram", "Load config failed", ERROR_COLOR, OUTPUT_CONSOLE | OUTPUT_TOAST | OUTPUT_MENU | OUTPUT_DEBUG, ICON_MD_CANCEL);
		return false;
	}
...
bool CConfigs::SaveVisual(const std::string& sConfigName, bool bNotify)
{
	try
	{
		...
		if (bNotify)
			SDK::Output("pastegram", std::format("Visual config {} saved", sConfigName).c_str(), INFO_COLOR, OUTPUT_CONSOLE | OUTPUT_TOAST | OUTPUT_MENU | OUTPUT_DEBUG, ICON_MD_INFO);
	}
	catch (...)
	{
		SDK::Output("pastegram", "Save visuals failed", ERROR_COLOR, OUTPUT_CONSOLE | OUTPUT_TOAST | OUTPUT_MENU | OUTPUT_DEBUG, ICON_MD_CANCEL);
		return false;
	}
	return true;
}
...
bool CConfigs::LoadVisual(const std::string& sConfigName, bool bNotify)
{
	try
	{
		...
		if (bNotify)
			SDK::Output("pastegram", std::format("Visual config {} loaded", sConfigName).c_str(), INFO_COLOR, OUTPUT_CONSOLE | OUTPUT_TOAST | OUTPUT_MENU | OUTPUT_DEBUG, ICON_MD_INFO);
	}
	catch (...)
	{
		SDK::Output("pastegram", "Load visuals failed", ERROR_COLOR, OUTPUT_CONSOLE | OUTPUT_TOAST | OUTPUT_MENU | OUTPUT_DEBUG, ICON_MD_CANCEL);
		return false;
	}
	return true;
}
...
void CConfigs::DeleteConfig(const std::string& sConfigName, bool bNotify)
{
	try
	{
		...
		if (bNotify)
			SDK::Output("pastegram", std::format("Config {} deleted", sConfigName).c_str(), INFO_COLOR, OUTPUT_CONSOLE | OUTPUT_TOAST | OUTPUT_MENU | OUTPUT_DEBUG, ICON_MD_INFO);
	}
	catch (...)
	{
		SDK::Output("pastegram", "Remove config failed", ERROR_COLOR, OUTPUT_CONSOLE | OUTPUT_TOAST | OUTPUT_MENU | OUTPUT_DEBUG, ICON_MD_CANCEL);
	}
}
...
void CConfigs::ResetConfig(const std::string& sConfigName, bool bNotify)
{
	try
	{
		...
		if (bNotify)
			SDK::Output("pastegram", std::format("Config {} reset", sConfigName).c_str(), INFO_COLOR, OUTPUT_CONSOLE | OUTPUT_TOAST | OUTPUT_MENU | OUTPUT_DEBUG, ICON_MD_INFO);
	}
	catch (...)
	{
		SDK::Output("pastegram", "Reset config failed", ERROR_COLOR, OUTPUT_CONSOLE | OUTPUT_TOAST | OUTPUT_MENU | OUTPUT_DEBUG, ICON_MD_CANCEL);
	}
}
...
void CConfigs::DeleteVisual(const std::string& sConfigName, bool bNotify)
{
	try
	{
		...
		if (bNotify)
			SDK::Output("pastegram", std::format("Visual config {} deleted", sConfigName).c_str(), INFO_COLOR, OUTPUT_CONSOLE | OUTPUT_TOAST | OUTPUT_MENU | OUTPUT_DEBUG, ICON_MD_INFO);
	}
	catch (...)
	{
		SDK::Output("pastegram", "Remove visuals failed", ERROR_COLOR, OUTPUT_CONSOLE | OUTPUT_TOAST | OUTPUT_MENU | OUTPUT_DEBUG, ICON_MD_CANCEL);
	}
}
...
void CConfigs::ResetVisual(const std::string& sConfigName, bool bNotify)
{
	...
	{
		SDK::Output("pastegram", "Reset visuals failed", ERROR_COLOR, OUTPUT_CONSOLE | OUTPUT_TOAST | OUTPUT_MENU | OUTPUT_DEBUG, ICON_MD_CANCEL);
	}
}
